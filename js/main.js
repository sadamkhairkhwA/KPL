...
const translations = {
  en: {
    ...
    "hero.badge": "B2B Pharmaceutical Distribution · Kabul",
    "hero.title1": "Health is a",
    "hero.title2": "Treasure",
    "hero.title3": "We Share",
    "hero.subtitle":
      "Khair Khwa Pharma is a licensed B2B pharmaceutical importer and distributor — supplying World Medicine (Turkey) products to licensed pharmacies, hospitals, clinics, NGOs, and authorized healthcare distributors across Afghanistan.",
    ...
    "about.title": "Trusted B2B Pharmaceutical Importer & Distributor in Afghanistan",
    "about.lead":
      "Khair Khwa Pharma (خیرخواه فارما) is a Kabul-based licensed B2B pharmaceutical importer and distributor — supplying healthcare institutions and authorized medical partners. We are not a public-facing online pharmacy.",
    "about.p1":
      "We import World Medicine (Turkey) products and distribute them through documented logistics to licensed pharmacies, hospitals, clinics, NGOs, and authorized healthcare distributors across Afghanistan. Khair Khwa Pharma does not provide direct-to-consumer pharmaceutical sales.",
    ...
    "about.f2title": "Nationwide B2B Distribution",
    "about.f2desc": "Reliable supply to licensed healthcare institutions across Afghanistan",
    ...
    "products.title": "Products We Supply",
    "products.desc":
      "B2B pharmaceutical products imported and distributed by Khair Khwa Pharma across Afghanistan — sourced from World Medicine (Turkey).",
    "products.sampleNote": "Imported via World Medicine · Turkey",
    "products.b2bOnly":
      "B2B supply only — these products are made available exclusively to licensed pharmacies, hospitals, clinics, NGOs, and authorized healthcare distributors. Khair Khwa Pharma does not sell directly to the public.",
    ...
    "contact.tag": "Request Information",
    "contact.title": "Partner With Khair Khwa Pharma",
    "contact.desc": "We supply pharmaceutical products to licensed pharmacies, hospitals, clinics, NGOs, and authorized healthcare distributors. Reach out for catalog details, availability, registration status, and import documentation.",
    "contact.b2bDisclaimer": "Khair Khwa Pharma supplies pharmaceutical products only to licensed healthcare institutions and authorized partners. We do not provide direct-to-consumer pharmaceutical sales.",
    ...
    "contact.note": "We typically respond to B2B inquiries within 24 hours.",
    ...
    "footer.tagline": "Licensed B2B pharmaceutical importer & distributor — serving licensed healthcare institutions across Afghanistan.",
    "footer.desc": "Official partner of World Medicine (Turkey). “Health is a treasure, we share.” — World Medicine.",
    "footer.disclaimer": "Khair Khwa Pharma supplies pharmaceutical products only to licensed pharmacies, hospitals, clinics, NGOs, and authorized healthcare distributors. We do not provide direct-to-consumer pharmaceutical sales.",
  ...
  fa: {
    ...
    "hero.subtitle":
      "خیرخواه فارما واردکننده و توزیع‌کننده مجاز B2B دارو است — تأمین محصولات World Medicine (ترکیه) برای دواخانه‌های مجاز، شفاخانه‌ها، کلینیک‌ها، NGOهای صحی و توزیع‌کنندگان مجاز دارو در سراسر افغانستان.",
    "hero.cta1": "مشاهده پورتفولیو",
    ...
    "about.tag": "ما کیستیم",
    "about.title": "واردکننده و توزیع‌کننده مجاز B2B دارو در افغانستان",
    "about.lead":
      "خیرخواه فارما (Khair Khwa Pharma) واردکننده و توزیع‌کننده مجاز B2B دارو در کابل است — تأمین مؤسسات صحی و شریکان مجاز طبی. ما یک دواخانه آنلاین برای مصرف‌کنندگان نیستیم.",
    "about.p1":
      "ما محصولات World Medicine (ترکیه) را وارد و از طریق لجستیک مستند به دواخانه‌های مجاز، شفاخانه‌ها، کلینیک‌ها، NGOها و توزیع‌کنندگان مجاز در سراسر افغانستان تأمین می‌کنیم. خیرخواه فارما هیچ‌گونه فروش مستقیم به مصرف‌کننده ارائه نمی‌دهد.",
    ...
    "about.f2title": "توزیع سراسری B2B",
    "about.f2desc": "رسانی مطمئن به مؤسسات صحی مجاز در سراسر افغانستان",
    "about.f3title": "زنجیره تأمین مستند",
    "about.f3desc": "ردیابی بچ و اسناد واردات برای هر محموله",
    "products.tag": "سبد محصولات",
    "products.title": "محصولاتی که عرضه می‌کنیم",
    "products.desc": "محصولات دارویی B2B که توسط خیرخواه فارما در سراسر افغانستان وارد و توزیع می‌شود — تأمین از World Medicine (ترکیه).",
    "products.sampleNote": "واردات از World Medicine · ترکیه",
    "products.b2bOnly":
      "عرضه فقط به‌صورت B2B — این محصولات صرفاً در اختیار دواخانه‌های مجاز، شفاخانه‌ها، کلینیک‌ها، مؤسسات غیردولتی (NGO) و توزیع‌کنندگان رسمی دارو قرار می‌گیرند. خیرخواه فارما هیچ‌گونه فروش مستقیم به مصرف‌کننده ندارد.",
    ...
    "contact.tag": "درخواست اطلاعات",
    "contact.title": "همکاری با خیرخواه فارما",
    "contact.desc": "ما محصولات دارویی را به دواخانه‌های مجاز، شفاخانه‌ها، کلینیک‌ها، NGOها و توزیع‌کنندگان مجاز دارو تأمین می‌کنیم. برای جزئیات کاتالوگ، موجودی، وضعیت ثبت و اسناد واردات با ما در تماس شوید.",
    "contact.b2bDisclaimer": "خیرخواه فارما محصولات دارویی را تنها به مؤسسات صحی مجاز و شریکان معتبر تأمین می‌کند. هیچ‌گونه فروش مستقیم به مصرف‌کننده ارائه نمی‌دهیم.",
    ...
    "contact.note": "معمولاً ظرف ۲۴ ساعت به درخواست‌های B2B پاسخ می‌دهیم.",
    "contact.sent": "سپاس — پیام شما ثبت شد. به زودی با شما تماس می‌گیریم.",
    "contact.error": "لطفاً فیلدها را بررسی کرده دوباره کوشش کنید.",
    "footer.tagline": "واردکننده و توزیع‌کننده مجاز B2B دارو — در خدمت مؤسسات صحی مجاز در سراسر افغانستان.",
    "footer.desc": "شریک رسمی World Medicine (ترکیه). «صحت یک گنج است، ما شریک می‌کنیم.» — World Medicine.",
    "footer.disclaimer": "خیرخواه فارما محصولات دارویی را تنها به دواخانه‌های مجاز، شفاخانه‌ها، کلینیک‌ها، NGOها و توزیع‌کنندگان مجاز دارو تأمین می‌کند. هیچ‌گونه فروش مستقیم به مصرف‌کننده ارائه نمی‌دهیم.",
